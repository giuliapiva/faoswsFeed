...
duck_protein_factor <- function() {
  ...
  rawData <-  getProdData(animal = "duck", func = "protein", area = area, year = year)
  
  namedData <- merge(rawData, codeTable[module == "duck" & fun == "protein", .(measuredItemCPC, measuredElement, variable)], 
