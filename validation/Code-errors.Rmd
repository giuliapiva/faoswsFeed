...
The following codes are present in the conversion table, but not in the actual M49 table.
...
The following codes are present in the conversion table, but not in the actual FAOSTAT table.
