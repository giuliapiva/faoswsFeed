...
setnames(olddata, c("area", "item", "year", "value", "flag"), c("geographicAreaM49", "measuredItemCPC", "timePointYears", "oldValue", "oldFlag"))
setkey(olddata, geographicAreaM49, measuredItemCPC, timePointYears)

raw_comparison <- olddata[newdata][, .(geographicAreaM49, country, measuredItemCPC, animal, timePointYears, oldValue, oldFlag, Value, flagObservationStatus)]
